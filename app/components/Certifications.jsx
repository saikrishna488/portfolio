...
const certifications = [
  ...
  },
  {
    ...
    icon: <FaMicrosoft className="text-blue-600 text-4xl" />
  },
  {
    title: "Python",
...
const CertificationCard = ({ title, description, link, icon }) => (
  <div className="bg-gradient-to-r from-gray-100 to-gray-200 p-6 rounded-lg shadow-lg hover:shadow-xl transition-transform transform hover:scale-105">
    <div className="flex items-center mb-4">
      {icon}
      <h4 className="text-xl font-semibold ml-4 text-blue-600">{title}</h4>
    </div>
    <p className="text-gray-700 mb-4">{description}</p>
    <a href={link} className="text-blue-500 hover:underline" target="_blank" rel="noopener noreferrer">View Certification</a>
  </div>
);
...
const Certifications = () => (
  <section id="certifications" className="py-16 bg-gray-100">
    <div className="container mx-auto px-6 text-center">
      <h3 className="text-4xl font-bold mb-12 text-blue-700 animate__animated animate__fadeIn">Certifications</h3>
